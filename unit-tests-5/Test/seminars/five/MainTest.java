...
class MainTest {
    ...
    void randomNumberTest(){
        ...
        List<Double> res = randomNumberModule.generateList(10);

//        assertEquals(10, res.size());
        assertThat(res).hasSize(10).isNotEmpty();
    }

    @Test
    void maxNumberListTest(){
        List<Double> doubleList = new ArrayList<>(Arrays.asList(30.0, 3.13, 70.32, 12.01, 132.55));
        MaxNumberModule maxNumberModule = new MaxNumberModule();

        double res = maxNumberModule.findMaxNumber(doubleList);
    ...
    void integrationTest(){
        ...
        List<Double> randomList = randomNumberModule.generateList(10);
        double result = maxNumberModule.findMaxNumber(randomList);
    ...
    void integrationOrderTest(){
        ...
        boolean result = orderService.placeOrder("12", 124.3);
